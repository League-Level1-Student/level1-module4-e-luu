...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		frame.setTitle("Jepardy");
		// 3. Create a JPanel variable to hold the header using the createHeader method

		quizPanel.add(createHeader("Greek Mythology"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("Who was the Earth?", "Gaea", 200);
		}
		...
		if (buttonPressed == secondButton) {
			askQuestion("Who is the Goddess of the rainbow?", "Iris", 400);
			secondButton.setText(" ");
		}
		if (buttonPressed == thirdButton) {
			askQuestion("What where half God and half human children called?", "demigods", 600);
			thirdButton.setText(" ");
		}
		if (buttonPressed == fourthButton) {
			askQuestion("Who was the goddess of Victory?", "Nike", 800);
			fourthButton.setText(" ");
		}
		//if (buttonPressed == fifthButton) {
			//askQuestion("Who was the hero who fell in love with Eros and became a goddess?", "Psych", 1000);
			//fifthButton.setText(" ");
		//}
